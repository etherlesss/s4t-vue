<template>
  ...
  <main class="container">
    ...
    <section class="top-container d-flex flex-column flex-md-row gap-md-5 p-3 mb-5">
      <img src="https://www.si-analytics.com/Image%20Library/sample-images/Placeholder-500x500.png" class="d-block mb-3 mb-md-0" alt="placeholder producto">
...
<style>@import '../css/details.less';</style>